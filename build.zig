...
pub fn build(b: *std.Build) void {
    ...
    build_options.addOption(bool, "test", b.option(bool, "test", "Builds in test mode.") orelse false);
    ...
    // exe_unit_tests.addOptions("build_options", build_options);

    const run_exe_unit_tests = b.addRunArtifact(exe_unit_tests);

    // run_exe_unit_tests.addOptions("build_options", build_options);
